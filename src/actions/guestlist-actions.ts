...
export async function createGuestLists(eventId: number, guestLists: GuestListFormValues[]) {
...
export async function updateEventGuestLists(eventId: number, guestLists: GuestListFormValues[]) {
